...
PYTHON2_PREFIX=${INSTPREFIX}/python-${PYTHON2_VERSION}
...
PYTHON3_PREFIX=${INSTPREFIX}/python-${PYTHON3_VERSION}
...
SQLITE_URL=https://sqlite.org/2016/${SQLITE_FILE}
